...
<form method="POST" action="<?php htmlspecialchars("PHP_SELF");?>">
    ...
    <div class="NAME">
               ...
               <div class="details">
               <div class="tags">
                     <span class="details-names">Surffix:</span>
                </div>
...
<div class="AB">
    ...
    <div class="B">
              <div class="details">
               ...
               <div class="details">
               <div class="tags">
                     <span class="details-names">Adress:</span>
              </div>
...
<div class="G">
  <h5>PERSON TO CONTACT</h5>
        ...
        <div class="NAME">
               ...
               <div class="details">
               <div class="tags">
                     <span class="details-names">Frist name:</span>
              </div>
...
Ø Culture of Excellence<br>
                     ...
                     <!--   <div class="qoutes">
                            <h4>The destination for leaders who seek to change the world</h4>
                           </div>-->
